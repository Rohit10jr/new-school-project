...
SECRET_KEY = 'django-insecure-ye!na%&@u55dhc9)@1e@(2k=q_d&tgg9x7br2wsj-=ie0)#@2e'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "statics"),  # This tells Django where to look for static files in development
]
