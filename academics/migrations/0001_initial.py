    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=1), blank=True, default=list, size=None)),
            ],
            options={
                'ordering': ('grade',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_detail', jsonfield.fields.JSONField()),
                ('grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='academics.grade')),
